...
const Footer = () => {
  ...
  const USEFUL_LINKS_LIST = [
    ...
    },
    {
      ...
      href: 'https://animegirl.studio',
    },
    {
      title: 'Best AI Girlfriend',
      href: 'https://aigirl.best',
    },
    {
    ...
    {
      title: 'OverflowAI',
      href: 'https://overflowai.dev',
    },
    {
      title: 'Free GPT-2 Output Detector',
      href: 'https://openai-openai-detector.com',
    },
  ];
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/Kling_AI_logo.png"
                    alt="logo"
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                      title={t('supportAndHelp.contactUs')}
                      type="email"
                    >
                      {t('supportAndHelp.contactUs')}
                    </a>
                  </li>
                </ul>
              </div>
